export const meta = {
 title: "BlackZack-Tech",
 author: "Blackzack",
 description: "I'm a full-stack developer based in Germany. I have a passion for building web applications and solving problems",
 //url: process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : `http://localhost:${process.env.PORT || 3000}`,
 url: "https://Blackzacktech.dev",
 locale: "en_US",
 siteName: "Blackzack-Tech",
 accounts: {
  github: {
   username: "blackzacktech",
   repo: "blackzacktech.dev",
  },
  twitter: {
   username: "@GoDBlackzack",
  },
  discord: {
   username: "@blackzack",
   invite: "https://discord.gg/PXSCVCwU4f",
   id: "432315647238733844",
  },
  instagram: {
   username: "benn202",
  },
...
export const projects = [
 {
  ...
  images: [
   {
    src: "/assets/projects/yurna/image-01.png",
    alt: "Yurna main page screenshot",
    width: 1920,
    height: 1080,
   },
  ],
  ...
  website: "https://yurna.info",
  github: "https://github.com/blackzacktech/yurna.info",
 },
 {
...
export const contact = {
 links: [
  {
   href: "mailto:mail@blackzacktech.dev",
   title: "Email",
   icon: (
